...
mellipsymb <- glm(mg.melanin.mg.tissue ~ nsymbiont_per_cm2 + mg.lipid.mg.tissue, data = MelaninLipNoOutliers, family=gaussian)
summary(mellipsymb)
...
melcarbsymb <- glm(nsymbiont_per_cm2 ~ mg.melanin.mg.tissue*mg.carb.mg.tissue, data =RI_21_DATANoMELOutliers, family = gaussian)
summary(melcarbsymb)
